# genpark-resilient-agentic-document-parser-workflow-automaton-skill
...
> **GenPark AI Agent Skill** -- Resilient agentic document parser & schema drift workflow automaton (Gumloop style)
